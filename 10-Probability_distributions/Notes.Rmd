...
# Functions
binomial_density_function <- dbinom(x = binomial_seq, size = 25, prob = 0.5)
binomial_distribution_function <- pbinom(q = binomial_seq, size = 25, prob = 0.5)

# Plot
par(mfrow=c(1,2))
plot(binomial_seq, binomial_density_function, ann = FALSE)
plot(binomial_seq, binomial_distribution_function, type = "S", ann = FALSE)
```
...
# Functions
Poisson_density_function <- dpois(x = Poisson_seq, lambda = 20)
Poisson_distribution_function <- ppois(q = Poisson_seq, lambda = 20)


# Plot
par(mfrow=c(1,2))
plot(Poisson_seq, Poisson_density_function, ann = FALSE)
plot(Poisson_seq, Poisson_distribution_function, type = "S", ann = FALSE)
```
```{r out.width = "75%", fig.align = "center"}
